...
<div class="container">
    ...
    <h1 class="my-4 text-center heading">Если Вы хотели заказать конкретный товар из примеров на сайте, перейдите <a
                href="<?= base_url() ?>order">по ссылке</a>
    </h1>
    <!--page header-->
    ...
    <form name="order_form" class="form-horizontal" action="<?= base_url() ?>order_phone" method="post">
        ...
        <div class="form-group" id="form_group_comment">
            <label class="control-label" for="comment">Что Вы хотели нам сказать:</label>
            <div id="form_comment">
